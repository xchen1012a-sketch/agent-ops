"""Pytest fixtures shared across the recruitment-assistant-agent test suite."""
...
from recruitment_assistant_agent.infrastructure.db import session as db_session
