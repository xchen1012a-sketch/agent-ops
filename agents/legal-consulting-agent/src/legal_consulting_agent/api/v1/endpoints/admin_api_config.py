...
from legal_consulting_agent.api.v1.schemas.agent_api_config import (
...
from legal_consulting_agent.core.errors import ConfigNotFoundError

router = APIRouter()

_API_TYPE_DEFAULTS = {
    "deepseek": "DeepSeek LLM（必需）",
    "embedding": "Embedding 服务（法律 RAG）",
    "vector_db": "向量库（法律 RAG）",
    "reranker": "Reranker（法律 RAG）",
    "ocr": "OCR（扫描材料可选）",
}
