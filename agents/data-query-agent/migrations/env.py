...
Runs migrations against the migration account (``DATABASE_MIGRATION_URL``)
to keep runtime DB privileges minimal. Import the project's ``Base.metadata``
so autogenerate has the full model set.
"""
...
from data_query_agent.infrastructure.db import models as _models  # noqa: F401
