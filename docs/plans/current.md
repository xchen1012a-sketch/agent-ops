...
- 当前执行入口：
  ...
  - Implemented LEGAL-150 admin high-risk review APIs: `GET /v1/high-risk-reviews`, `POST /v1/high-risk-reviews/{review_id}/resolution`; requires administrator user mirror.
- 暂不具备 / 后置依赖：
